layui.use(['layer','form','table'], function() {
    var layer = layui.layer,
        ...
        t;              //表格变量
    //监听工具条
    table.on('tool(zkMajorList)', function(obj){
        var data = obj.data;
        if(obj.event === 'edit'){
    ...
    var active={
        ...
        deleteSome : function(){
            ...
            if(data.length > 0){
                ...
                layer.confirm("你确定要删除这些专业么？",{btn:['是的,我确定','我再想想']},
                    function(){
                        var deleteindex = layer.msg('删除中，请稍候',{icon: 16,time:false,shade:0.8});
                        $.ajax({
                            type:"POST",
                            url:"/major/deleteSome",
                            dataType:"json",
                ...
                layer.msg("请选择需要删除的专业",{time:1000});
            }
        }
    };
